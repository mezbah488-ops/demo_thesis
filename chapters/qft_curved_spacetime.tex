...
The effective action formalism developed in Part~\ref{part:eff-action}
was built on the assumption that the background spacetime is flat
Minkowski space. Before we can extend it to curved spacetime, we need
to understand the global causal structure of the spacetimes we are
working with. This chapter introduces the Schwarzschild geometry and
its maximal extension, develops the Kruskal and Penrose diagram
technology that makes the causal structure transparent, and identifies
the key features, the horizon and the singularity, that will drive the
physics of particle production in later chapters.
